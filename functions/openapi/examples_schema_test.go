...
components:
  schemas:
	...
	assert.Contains(t, res[0].Message, `failed to compile JSON schema: OpenAPI keyword 'nullable': nullable keyword is not allowed in OpenAPI 3.1+ Schemas; use 'type' with 'null' instead`)
}
