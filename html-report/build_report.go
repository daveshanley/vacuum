...
// AssetsAvailable indicates whether the interactive HTML report UI bundles were
// compiled into this build. Official release builds enable this using the
// `html_report_ui` build tag.
func AssetsAvailable() bool {
	return htmlReportUIEnabled
}
