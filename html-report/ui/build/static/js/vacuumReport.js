...
`;var ze=function(e,t,o,r){var i,a=arguments.length,n=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var l=e.length-1;l>=0;l--)(i=e[l])&&(n=(a<3?i(n):a>3?i(t,o,n):i(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let je=class extends ke{disableCategory(){this.active=!1,this.requestUpdate()}enableCategory(){this.active=!0,this.requestUpdate()}toggleCategory(e=!0){if(this.active=!this.active,e){const e={detail:{id:this.name,description:this.description},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent($e,e))}this.requestUpdate()}render(){return Q`
      <li>
        <a
          href="#"
    ...
    `}};je.styles=Ce,ze([xe({type:String})],je.prototype,"name",void 0),ze([xe({type:Boolean})],je.prototype,"default",void 0),ze([xe({type:String})],je.prototype,"description",void 0),je=ze([ye("rule-category-link")],je);let Re=class extends ke{static get styles(){return[w`
      .html-report {
        height: 100%;
      }
    `]}render(){return Q`
...
`;var Oe=function(e,t,o,r){var i,a=arguments.length,n=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var l=e.length-1;l>=0;l--)(i=e[l])&&(n=(a<3?i(n):a>3?i(t,o,n):i(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let Te=class extends ke{connectedCallback(){super.connectedCallback(),this._violationId=Math.random().toString(20).substring(2)}get violationId(){return this._violationId}render(){return Q` <nav
      ...
      <div class="code-render">
        <slot></slot>
      </div>`}_violationClicked(){let e;this._renderedCode?e=this._renderedCode:(e=this._slottedChildren[0],this._renderedCode=e);const t={detail:{message:this.message,id:this.ruleId,startLine:this.startLine,startCol:this.startCol,endLine:this.endLine,endCol:this.endCol,path:this.path,category:this.category,howToFix:this.howToFix,violationId:this.violationId,renderedCode:e},bubbles:!0,composed:!0};this.dispatchEvent(new CustomEvent("violationSelected",t))}};Te.styles=Le,Oe([xe({type:String})],Te.prototype,"message",void 0),Oe([xe({type:String})],Te.prototype,"category",void 0),Oe([xe({type:String})],Te.prototype,"ruleId",void 0),Oe([xe({type:Number})],Te.prototype,"startLine",void 0),Oe([xe({type:Number})],Te.prototype,"startCol",void 0),Oe([xe({type:Number})],Te.prototype,"endLine",void 0),Oe([xe({type:Number})],Te.prototype,"endCol",void 0),Oe([xe({type:String})],Te.prototype,"path",void 0),Oe([xe({type:String})],Te.prototype,"howToFix",void 0),Oe([xe({type:Boolean})],Te.prototype,"selected",void 0),Te=Oe([ye("category-rule-result")],Te);const Me=w`
  .rule-icon {
    font-family: 'Arial';
...
`;let Ge=class extends ke{static get styles(){const e=w``;return[Fe,e]}render(){return Q`
      <slot
        @violationSelected=${this._violationSelectedListener}
        name="violation"
      ></slot>
  ...
  `];var We,Ze=function(e,t,o,r){var i,a=arguments.length,n=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var l=e.length-1;l>=0;l--)(i=e[l])&&(n=(a<3?i(n):a>3?i(t,o,n):i(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let Je=We=class extends ke{static replaceTicks(e){const t=/(`[^`]*`)/g,o=e.split(t),r=new Array;return o.forEach((e=>{if(e.match(t)){const t=e.replace(/`/g,""),o=Q`<span class="backtick-element">${t}</span>`;r.push(o)}else""!=e&&r.push(Q`${e}`)})),r}render(){return this._visible?Q`
        ...
        <p class="violated">
          Learn more about:
          <a
            href="https://quobix.com/vacuum/rules/${this.category}/${this.ruleId.replace("$","")}"
            >${this.ruleId}</a
          >
        </p>
      `:Q`
      ...
      `}get drawer(){return document.querySelector("violation-drawer")}show(){this._visible=!0,this.drawer.classList.add("drawer-active"),this.requestUpdate()}hide(){this._visible=!1,this.drawer.classList.remove("drawer-active"),this.requestUpdate()}};Je.styles=Ke,Ze([xe({type:Element})],Je.prototype,"code",void 0),Ze([xe({type:String})],Je.prototype,"message",void 0),Ze([xe({type:String})],Je.prototype,"path",void 0),Ze([xe({type:String})],Je.prototype,"category",void 0),Ze([xe({type:String})],Je.prototype,"ruleId",void 0),Ze([xe({type:String})],Je.prototype,"howToFix",void 0),Je=We=Ze([ye("violation-drawer")],Je);var Xe=function(e,t,o,r){var i,a=arguments.length,n=a<3?t:null===r?r=Object.getOwnPropertyDescriptor(t,o):r;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(e,t,o,r);else for(var l=e.length-1;l>=0;l--)(i=e[l])&&(n=(a<3?i(n):a>3?i(t,o,n):i(t,o))||n);return a>3&&n&&Object.defineProperty(t,o,n),n};let Qe=class extends ke{static get styles(){return[w`
      span {
        display: block;
      }
