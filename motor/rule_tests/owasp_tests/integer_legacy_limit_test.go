...
func TestRuleSet_GetOWASPRuleIntegerLegacyLimit_Success(t *testing.T) {
...
`,
	...
	for _, tt := range tc {
		t.Run(tt.name, func(t *testing.T) {
			...
			rules["here"] = rulesets.GetOWASPRuleIntegerLegacyLimit() // TODO
...
func TestRuleSet_GetOWASPRuleIntegerLegacyLimit_Error(t *testing.T) {
