...
const (
	...
	requiredFieldsDefinedFix string = "If a field is listed in `required`, declare it explicitly in `properties` or restructure the schema so the required field is defined through composition."
