...
func GetOldDashboardCommand() *cobra.Command {

	cmd := &cobra.Command{
		Use:     "dashboard-old",
		Short:   "Show legacy vacuum dashboard for linting report (deprecated)",
		Long:    "Legacy interactive console dashboard using termui (deprecated - use 'dashboard' for new UI)",
		Example: "vacuum dashboard-old my-awesome-spec.yaml",
